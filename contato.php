...
$result3 = mysqli_query($db, $query_lanchonete);
...
<section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/lanchonete.jpg');"
        ...
        <div class="row block-9">
            <div class="col-md-6 order-md-last d-flex">
                <div class="row d-flex mb-5 contact-info">
                    ...
                    <div class="w-100"></div>
                    <?php while ($endereco = mysqli_fetch_array($result3)) { ?>
                        <div class="col-md-3">
                            <p><span>Endereço: </span><?php echo $endereco['endereco']; ?></p>
                        </div>
                        <div class="col-md-3">
                            <p><span>Telefone:</span> <a
                                        href="tel://1234567920"><?php echo $endereco['telefone']; ?></a></p>
                        </div>
                        <div class="col-md-3">
                            <p><span>CNPJ:</span> <?php echo $endereco['cnpj']; ?></p>
                        </div>
                    <?php } ?>
                </div>
            </div>
